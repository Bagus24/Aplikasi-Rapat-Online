...
<div class="main-card mb-3 card">
    <div class="card-body">
        ...
        <div class="float-right">
            <form class="form-inline" action="{{ url('notula-rapat/cari') }}" method="GET">
            ...
            <table class="mb-0 table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $a->tanggal }}</td>
                        <td>{{ $a->kode }}</td>
                        <td><a class="mb-2 mr-2 btn btn-light p-1" target="_blank" href="{{ url('cetak-notula', $a->id) }}">Cetak</a></td>
                    </tr>
                    @endforeach
                    @else
                    <tr>
