...
<div class="main-card mb-3 card">
    <div class="card-body">
        <h5 class="card-title">Sunting Data Agenda</h5>
        <br>
        <form class="" method="POST" action="{{ route('agenda.update', $agenda->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <select name="jenis" id="jenis" class="form-control">
                        <option value="{{ $agenda->jenis }}">{{ $agenda->jenis }}</option>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input id="pembahasan" maxlength="100" placeholder="masukan tema pembahasan.." type="text" class="form-control @error('pembahasan') is-invalid @enderror" name="pembahasan" value="{{ $agenda->pembahasan }}" required autofocus>
                    @error('pembahasan')
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input value="{{ $agenda->tanggal }}" id="datepicker" maxlength="10" placeholder="masukan tanggal rapat.." type="date" class="form-control @error('tanggal') is-invalid @enderror" name="tanggal" required>
                    @error('tanggal')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input id="mulai" placeholder="masukan waktu mulai rapat.." type="time" class="form-control @error('mulai') is-invalid @enderror" name="mulai" value="{{ $agenda->mulai }}" required>
                    @error('mulai')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <input id="selesai" placeholder="masukan waktu selesai rapat.." type="time" class="form-control @error('selesai') is-invalid @enderror" name="selesai" value="{{ $agenda->selesai }}" required>
                    @error('selesai')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    <select name="kode" id="ruangan" class="form-control">
                        <option value="{{ $agenda->kode }}">{{ $agenda->kode }}</option>
            ...
            <div class="position-relative row form-group">
                <label for="pimpinan" class="col-sm-2 col-form-label">Pimpinan Rapat</label>
                <div class="col-sm-10">
                    <select name="pimpinan" id="pemimpin" class="form-control">
                        <option value="{{ $agenda->pimpinan }}">{{ $agenda->pimpinan }}</option>
                        @foreach($peserta as $pes)
                        <option value="{{ $pes->nama }}">{{ $pes->nama }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="position-relative row form-group">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="custom-checkbox custom-control">
                        ...
                        {{ in_array($p->nipy, $explode)?"checked":"" }} >
