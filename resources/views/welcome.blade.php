                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="position-relative form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input id="nipy" maxlength="10" type="text" class="form-control @error('nipy') is-invalid @enderror" name="nipy" value="{{ old('nipy') }}" required autocomplete="nipy" autofocus>
                                                @error('nipy')
                                            ...
                                            <div class="col-md-12">
                                                <input id="password" maxlength="50" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                                                @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
